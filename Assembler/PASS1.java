...
class PASS1 
{
	public static void main(String args[]) throws NullPointerException, FileNotFoundException
	{
	 ...
	 String line; 
	 try{
		 BufferedReader br=new BufferedReader(new FileReader("C:\\PROGRAMMING\\SposLab\\Assembler\\Sample.txt"));
		 BufferedWriter bw=new BufferedWriter(new FileWriter("C:\\PROGRAMMING\\SposLab\\Assembler\\Output.txt"));
	 ...
	 BufferedReader br=new BufferedReader(new FileReader("C:\\PROGRAMMING\\SposLab\\Assembler\\Output.txt"));
	 System.out.println("\n***********************Output1.txt***********************\n");
	 try {
