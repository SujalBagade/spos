...
public class MPass2 {
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader br1=new BufferedReader(new FileReader("C:/PROGRAMMING/SposLab/MPass2/mnt.txt"));
        String line;
        while((line = br1.readLine())!=null)
        {
            String[] parts=line.split("\\s+");
            System.out.println("\t"+"\t"+parts[0]+"\t"+parts[1]+"\t\t"+parts[2]);
            MNT[mnt_cnt++] = new mnt(parts[0], Integer.parseInt(parts[1]));
        ...
        br1=new BufferedReader(new FileReader("C:/PROGRAMMING/SposLab/MPass2/argmnt.txt"));
        while((line = br1.readLine())!=null)
        {
        ...
        br1=new BufferedReader(new FileReader("C:/PROGRAMMING/SposLab/MPass2/mdt.txt"));
        while((line = br1.readLine())!=null)
        {
            MDT[mdt_cnt]=new mdt();
        ...
        br1=new BufferedReader(new FileReader("C:/PROGRAMMING/SposLab/MPass2/input.txt"));
        arglist[] actual_parameter=new arglist[10];
        
        BufferedWriter bw1 = new BufferedWriter(new FileWriter("C:/PROGRAMMING/SposLab/MPass2/output.txt"));
        while((line = br1.readLine())!=null)
        {
